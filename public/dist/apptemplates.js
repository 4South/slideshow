...
Ember.TEMPLATES["_sampletext"] = Ember.Handlebars.template(function anonymous(Handlebars,depth0,helpers,partials,data) {
this.compilerInfo = [2,'>= 1.0.0-rc.3'];
helpers = helpers || Ember.Handlebars.helpers; data = data || {};
  


  data.buffer.push("<span id = \"sampleText\"> Sample </id>");
...
Ember.TEMPLATES["slideshowcreate"] = Ember.Handlebars.template(function anonymous(Handlebars,depth0,helpers,partials,data) {
this.compilerInfo = [2,'>= 1.0.0-rc.3'];
helpers = helpers || Ember.Handlebars.helpers; data = data || {};
  var buffer = '', hashTypes, escapeExpression=this.escapeExpression;


  data.buffer.push("<section id = \"slideshowcreate\">\r\n  <h3>Slideshow Creation</h3>\r\n  <span style = \"display:block;\">\r\n  ");
  ...
  data.buffer.push(escapeExpression(helpers.view.call(depth0, "Ember.Select", {hash:{
    'prompt': ("Please choose a theme"),
    'contentBinding': ("controller.availableThemes"),
...
function program4(depth0,data) {
  ...
  data.buffer.push("\r\n      <button class = \"btn-small btn-warning\"\r\n        ");
  hashTypes = {};
  data.buffer.push(escapeExpression(helpers.action.call(depth0, "goToSlideshowCreation", {hash:{},contexts:[depth0],types:["STRING"],hashTypes:hashTypes,data:data})));
